...
// TODO: Remove this rule after testing - You MUST create only 2 test cases: happy path and edge case
export const plannerAgent = new Agent({
  ...
  instructions: `You are an PLANNER-AGENT designed to generate E2E test scenarios within a multi-agent system.
    ...
    - You MUST create only 2 test cases: happy path and edge case.
    - Use only the tags: happy-path, edge-case, validation, auth, form, error, navigation, multi-user, regression.
